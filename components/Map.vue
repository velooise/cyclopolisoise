...
const types = ref(['bidirectionnelle', 'bilaterale', 'voie-bus', 'voie-bus-elargie', 'velorue', 'voie-verte', 'bandes-cyclables', 'zone-de-rencontre','zone-30', 'imp+debouche-cyclable', 'piste-sur-trottoir','chaucidou','aucun', 'inconnu']);
