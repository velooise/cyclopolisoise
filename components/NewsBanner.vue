<template>
  <div
    v-show="lastNewsItem"
    class="transition-all ease-in-out h-0 duration-500 relative isolate flex items-center gap-x-6 overflow-hidden bg-lvv-blue-100 px-6 sm:px-3.5 sm:before:flex-1"
    :class="showBanner ? 'h-[fit-content] py-2.5 opacity-100' : 'h-0 py-0 opacity-0'"
  >
    <div
    ...
    >
      <div
        class="aspect-[577/310] w-[36.0625rem] bg-gradient-to-r from-lvv-pink to-[#9089fc] opacity-70"
        style="
          clip-path: polygon(
            74.8% 41.9%,
            97.2% 73.2%,
    ...
    <div v-if="lastNewsItem" class="flex flex-wrap items-center gap-x-4 gap-y-1">
